...
expInfo = {'المشارك': '', 'العمر': '', 'الجنس': '', 'بلد الإقامة': '', 'اللغة الأم': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/rayanekouzy/Documents/PsychopyCodes/PsychopyPavlovia/chimeric-face-task-arabic/ArbChimericFaceTask_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='الرجاء قراءة استمارة الموافقة و الضغط على شريط المسافة للمتابعة (space bar)',
    font='Arial',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='أولاً، سوف نطرح عليك بعض الأسئلة حول معرفتك اللغوية\n\nو بعد ذلك، ستقوم بالمهمة التجريبية\n\nستستغرق التجربة بأكملها حوالي  30 دقيقة\n\nاضغط على شريط المسافة للمتابعة (space bar)',
    font='Arial',
...
InstrLanguages = visual.TextStim(win=win, name='InstrLanguages',
    text='ما هي اللغة التي تعرفها بطلاقة؟\n',
    font='Arial',
    pos=[0.16,0.3], height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
    depth=0.0);
InstrLang2 = visual.TextStim(win=win, name='InstrLang2',
    text='١. الإنجليزية أو الفرنسية أو لغة أوروبية أخرى\n',
    font='Arial',
    pos=(0.1,0.2), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
    depth=-1.0);
InstrLang3 = visual.TextStim(win=win, name='InstrLang3',
    text='٢. العربية، العبرية، الأردية، الفارسية، الآرامية، الآذرية أو الكردية\n',
    font='Arial',
    pos=(0.02, 0.1), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
    depth=-2.0);
InstrLang4 = visual.TextStim(win=win, name='InstrLang4',
    ...
    languageStyle='Arabic',
    depth=-3.0);
InstrLang5 = visual.TextStim(win=win, name='InstrLang5',
    text='٤. الصينية أو اليابانية أو الكورية\n',
    font='Arial',
    pos=(0.2, -0.1), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
    depth=-4.0);
InstrLang6 = visual.TextStim(win=win, name='InstrLang6',
    ...
    languageStyle='Arabic',
    depth=-5.0);
InstrLang7 = visual.TextStim(win=win, name='InstrLang7',
    text='٦. أخرى\n',
    font='Arial',
...
spaceTextLang = visual.TextStim(win=win, name='spaceTextLang',
    text='اضغط على شريط المسافة للمتابعة (space bar)',
    font='Arial',
...
textProficiencyEng = visual.TextStim(win=win, name='textProficiencyEng',
    ...
    languageStyle='Arabic',
    depth=0.0);
MouseInstruction = visual.TextStim(win=win, name='MouseInstruction',
    text='\nاستخدم الماوس للرد على هذه الأسئلة\n',
    font='Arial',
    pos=(0.18, 0.28), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
    depth=-1.0);
...
textActivitiesEng = visual.TextStim(win=win, name='textActivitiesEng',
    text='إلى أي مدى تستخدم اللغة الإنجليزية أو لغة مكتوبة من اليسار إلى اليمين عند:\n\nاستخدم الماوس للرد على هذه الأسئلة  \n',
    font='Arial',
...
hoursReading = visual.TextStim(win=win, name='hoursReading',
    text='\nكم ساعة في اليوم تقضيها في قراءة مواد (إما مطبوعة أو على الإنترنت) باللغة الإنجليزية أو لغة مكتوبة من اليسار إلى اليمين\n\nاستخدم الماوس للرد على هذا السؤال\n',
    font='Arial',
...
textActivitiesAr = visual.TextStim(win=win, name='textActivitiesAr',
    text='إلى أي مدى تستخدم اللغة العربية أو لغة مكتوبة من اليمين إلى اليسار عند:\n\nاستخدم الماوس للرد على هذه الأسئلة\n',
    font='Arial',
...
readingAr = visual.TextStim(win=win, name='readingAr',
    text='كم ساعة / يوم تقرأ مواد (إما مطبوعة أو عبر الإنترنت) باللغة العربية أو لغة مكتوبة من اليمين إلى اليسار:\n\nاستخدم الماوس للرد على هذا السؤال',
    font='Arial',
    units='height', pos=(0, 0.3), height=0.03, wrapWidth=27, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
...
textCountAr = visual.TextStim(win=win, name='textCountAr',
    text='هل سبق لك أن عشت في بلد حيث اللغة العربية أو العبرية أو الأردية،\nأو الفارسية أو الآرامية هي اللغة السائدة للتواصل ؟\n\n\n\n١.نعم\n\n\n٢. لا\n',
    font='Arial',
...
textLongCountAr = visual.TextStim(win=win, name='textLongCountAr',
    text='\nمنذ متى وأنت تعيش في هذا البلد/البلدان؟\n\n١.أقل من سنة واحدة\n\n٢.٢-٣ سنوات\n\n٣. ٤-٧ سنوات\n\n٤. أكثر من ٧ سنوات\n',
    font='Arial',
...
QDone = visual.TextStim(win=win, name='QDone',
    text=' اكتمل الاستبيان!\n \nاضغط على شريط المسافة لمتابعة التجربة (space bar)\n',
    font='Arial',
    units='height', pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='Black', colorSpace='rgb', opacity=1, 
    languageStyle='Arabic',
...
_fluentLang_allKeys = []
# keep track of which components have finished
LanguagesComponents = [InstrLanguages, InstrLang2, InstrLang3, InstrLang4, InstrLang5, InstrLang6, InstrLang7, fluentLang, spaceTextLang]
...
while continueRoutine:
    ...
    # *InstrLang2* updates
    if InstrLang2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang2.frameNStart = frameN  # exact frame index
        InstrLang2.tStart = t  # local t and not account for scr refresh
        InstrLang2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang2, 'tStartRefresh')  # time at next scr refresh
        InstrLang2.setAutoDraw(True)
    
    # *InstrLang3* updates
    if InstrLang3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang3.frameNStart = frameN  # exact frame index
        InstrLang3.tStart = t  # local t and not account for scr refresh
        InstrLang3.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang3, 'tStartRefresh')  # time at next scr refresh
        InstrLang3.setAutoDraw(True)
    
    # *InstrLang4* updates
    if InstrLang4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang4.frameNStart = frameN  # exact frame index
        InstrLang4.tStart = t  # local t and not account for scr refresh
        InstrLang4.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang4, 'tStartRefresh')  # time at next scr refresh
        InstrLang4.setAutoDraw(True)
    
    # *InstrLang5* updates
    if InstrLang5.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang5.frameNStart = frameN  # exact frame index
        InstrLang5.tStart = t  # local t and not account for scr refresh
        InstrLang5.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang5, 'tStartRefresh')  # time at next scr refresh
        InstrLang5.setAutoDraw(True)
    
    # *InstrLang6* updates
    if InstrLang6.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang6.frameNStart = frameN  # exact frame index
        InstrLang6.tStart = t  # local t and not account for scr refresh
        InstrLang6.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang6, 'tStartRefresh')  # time at next scr refresh
        InstrLang6.setAutoDraw(True)
    
    # *InstrLang7* updates
    if InstrLang7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        InstrLang7.frameNStart = frameN  # exact frame index
        InstrLang7.tStart = t  # local t and not account for scr refresh
        InstrLang7.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(InstrLang7, 'tStartRefresh')  # time at next scr refresh
...
for thisComponent in LanguagesComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('InstrLang2.started', InstrLang2.tStartRefresh)
thisExp.addData('InstrLang2.stopped', InstrLang2.tStopRefresh)
thisExp.addData('InstrLang3.started', InstrLang3.tStartRefresh)
thisExp.addData('InstrLang3.stopped', InstrLang3.tStopRefresh)
thisExp.addData('InstrLang4.started', InstrLang4.tStartRefresh)
thisExp.addData('InstrLang4.stopped', InstrLang4.tStopRefresh)
thisExp.addData('InstrLang5.started', InstrLang5.tStartRefresh)
thisExp.addData('InstrLang5.stopped', InstrLang5.tStopRefresh)
thisExp.addData('InstrLang6.started', InstrLang6.tStartRefresh)
thisExp.addData('InstrLang6.stopped', InstrLang6.tStopRefresh)
thisExp.addData('InstrLang7.started', InstrLang7.tStartRefresh)
thisExp.addData('InstrLang7.stopped', InstrLang7.tStopRefresh)
# check responses
...
# keep track of which components have finished
ProficiencyEngComponents = [textProficiencyEng, MouseInstruction, engSpeak, engRead, engWrite, eSpeakLabel, eReadLabel, eWriteLabel, spaceText, spaceKey, mouseProf]
...
while continueRoutine:
    ...
    if MouseInstruction.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        MouseInstruction.frameNStart = frameN  # exact frame index
        MouseInstruction.tStart = t  # local t and not account for scr refresh
        MouseInstruction.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(MouseInstruction, 'tStartRefresh')  # time at next scr refresh
...
for thisComponent in ProficiencyEngComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('MouseInstruction.started', MouseInstruction.tStartRefresh)
thisExp.addData('MouseInstruction.stopped', MouseInstruction.tStopRefresh)
