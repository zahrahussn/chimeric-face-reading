...
function consentFormLoopLoopBegin(thisScheduler) {
  ...
  for (const thisConsentFormLoop of consentFormLoop) {
...
function AcceptConsentRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of AcceptConsentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function QstartRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of QstartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function LanguagesRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of LanguagesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ProficiencyEngRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ProficiencyEngComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ActivitiesEngRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ActivitiesEngComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ReadingEngRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ReadingEngComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ProficiencyArRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ProficiencyArComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ActivitiesArRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ActivitiesArComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function ReadingArRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of ReadingArComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function TimeArRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of TimeArComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Q_FinishRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of Q_FinishComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
